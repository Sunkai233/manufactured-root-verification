...
- **阶次×精度全因子 M1–M9**:吞吐 fp64 525/459/398、df32 424/406/375、fp32 25367/22325/19878 M根/s(阶次↑→吞吐↓;fp32 碾压);精度按 u 分层。见 `v2_cpp/figs_v2/fig9_matrix.*`。
...
- **能耗**(修正协议,扣空载,饱和吞吐):G3 fp64 0.257 / G4 df32 0.674 / G5 fp32 0.020 J/百万根。
